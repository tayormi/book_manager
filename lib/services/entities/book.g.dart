...
const BookSchema = CollectionSchema(
  ...
  indexes: {},
  links: {
    r'bookCategory': LinkSchema(
      id: -4999358333044461962,
      name: r'bookCategory',
      target: r'BookCategory',
      single: true,
    ),
    r'author': LinkSchema(
...
Book _bookDeserialize(
  ...
  object.id = id;
  object.isbn = reader.readString(offsets[1]);
...
List<IsarLinkBase<dynamic>> _bookGetLinks(Book object) {
  return [object.bookCategory, object.author];
}

void _bookAttach(IsarCollection<dynamic> col, Id id, Book object) {
  object.id = id;
  object.bookCategory
      .attach(col, col.isar.collection<BookCategory>(), r'bookCategory', id);
...
extension BookQueryLinks on QueryBuilder<Book, Book, QFilterCondition> {
  QueryBuilder<Book, Book, QAfterFilterCondition> bookCategory(
      FilterQuery<BookCategory> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'bookCategory');
    });
  }

  QueryBuilder<Book, Book, QAfterFilterCondition> bookCategoryIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'bookCategory', 0, true, 0, true);
    });
  }
